...
export function Subscription(name: string, options: SubscriptionOptions): MethodDecorator;
...
export function Subscription(
  ...
  return (target: Object | Function, key?: string | symbol, descriptor?: any) => {
    ...
    SetMetadata(SUBSCRIPTION_OPTIONS_METADATA, options)(target, key, descriptor);
